...
IOINITDATA:
    ...
    db 0feh, 1, 000h
    db 0fah, 1, 0ffh
    db 0f9h, 3, 04fh, 0cfh, 000h
    db 0fbh, 3, 04fh, 0cfh, 040h
    db 0f8h, 1, 0c0h
    db 0fah, 3, 0fbh, 03bh, 0fbh
    db 0edh, 1, 000h
    db 0e8h, 1, 040h
    db 0ebh, 4, 048h, 049h, 04ah, 04bh
    db 0e2h, 2, 000h, 00
    db 0e3h, 2, 000h, 00
    db 0f4h, 4, 003h, 0f0h, 057h, 02h
    db 0f5h, 2, 057h, 02
    db 0f6h, 3, 003h, 0d5h, 001h
    db 0f7h, 3, 003h, 0d5h, 001h
    db 0f1h, 11, 000h, 00, 0d8h, 04h, 044h, 001h, 060h, 003h, 0c1h, 05h, 0eah
    db 0f3h, 11, 000h, 00, 0d8h, 04h, 044h, 001h, 060h, 003h, 0c1h, 05h, 0eah
	...
	add a,h			;0e59	84 	. 
	ld e,(hl)			;0e5a	5e 	^ 
	ld hl,02340h		;0e5b	21 40 23 	! @ # 
	inc h			;0e5e	24 	$ 
	dec h			;0e5f	25 	% 
	ld h,02ah		;0e60	26 2a 	& * 
	jr z,l0e8dh		;0e62	28 29 	( ) 
	ld (03c3ah),hl		;0e64	22 3a 3c 	" : < 
	dec hl			;0e67	2b 	+ 
	ld a,03fh		;0e68	3e 3f 	> ? 
	ld a,(hl)			;0e6a	7e 	~ 
	ld b,c			;0e6b	41 	A 
	ld b,d			;0e6c	42 	B 
	ld b,e			;0e6d	43 	C 
...
l0e8dh:
	...
	add a,e			;0e98	83 	. 
	add a,h			;0e99	84 	. 
	jr nc,l0ecdh		;0e9a	30 31 	0 1 
	ld (03433h),a		;0e9c	32 33 34 	2 3 4 
	dec (hl)			;0e9f	35 	5 
	ld (hl),037h		;0ea0	36 37 	6 7 
	jr c,$+59		;0ea2	38 39 	8 9 
	ld a,(02c3bh)		;0ea4	3a 3b 2c 	: ; , 
	dec a			;0ea7	3d 	= 
	ld l,02fh		;0ea8	2e 2f 	. / 
	nop			;0eaa	00 	. 
